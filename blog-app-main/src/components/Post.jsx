...
function Post({ post = { id: -1, title: "This is default Tutorials title", content: "This is default Tutorial content" }, deletePost }) {
                        ...
                        <>
                            ...
                            {user.roles.map((role) => (
                                role.name === "ROLE_ADMIN" ? (
                                    <span>
                                        <Button onClick={(event) => deletePost(post)} color='danger' className="ms-2">
                                            Delete
                                        </Button>
