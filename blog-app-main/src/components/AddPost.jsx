...
const AddPost = () => {
    ...
    const createPost = (event) => {
        ...
        if (post.content.trim() === '') {
            toast.error("Tutorial content is required !!")
            return
        }
        ...
        doCreatePost(post).then(data => {
            ...
            toast.error("Tutorial not created due to some error !!")
            // console.log(error)
        })
            ...
            <Card className="shadow-sm  border-0 mt-2">
                <CardBody>
                    ...
                    <Form onSubmit={createPost}>
                        ...
                        <div className="mt-3">
                            <Label for="image">Select images for Tutorial </Label>
                        ...
                        <Container className="text-center">
                            <Button type="submit" className="rounded-0" color="primary">Create Tutorial</Button>
