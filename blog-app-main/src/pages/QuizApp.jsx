...
export default function QuizApp() {
  ...
  return (
    ...
    <Container>
      <center>
        <br />
        <h3>!! Test Your Knowledge Here !!</h3><hr />
      </center>
                  ...
                  {Object.keys(questions[currentQuestionIndex].answers).map((key, index) => (
                    questions[currentQuestionIndex].answers[key] && (
                      <li key={key}>
                        ...
                        />
                        <label htmlFor={`option-${key}`} style={{ fontSize: '16px' , fontFamily: 'Roboto, sans-serif' }}>{questions[currentQuestionIndex].answers[key]}</label>
                      </li>
                    )
                  ))}
                </ul>
