...
function UpdateTutorial() {
    ...
    useEffect(() => {
        ...
        loadPost(blogId).then(data => {
            ...
            .catch(error => {
                console.log(error);
                toast.error("error in loading the Tutorial")
            })
    }, [])
    ...
    useEffect(() => {
        ...
        if (post) {
            if (post.user.id != object.user.data.id) {
                toast.error("This is not your Tutorial !!")
                navigate("/")
            }
    ...
    const updatePost = (event) => {
        ...
        doUpdatePost({ ...post, category: { categoryId: post.categoryId } }, post.postId)
            ...
            .catch(error => {
                console.log(error);
                toast.error("Error in upading Tutorial")
            })
                ...
                <Card className="shadow-sm  border-0 mt-2">
                    <CardBody>
                        ...
                        <Form onSubmit={updatePost} >
                            ...
                            <div className="mt-3">
                                <Label for="image">Select image for Tutorial</Label>
                            ...
                            <Container className="text-center">
                                <Button type="submit" className="rounded-0" color="primary">Update  Tutorial</Button>
